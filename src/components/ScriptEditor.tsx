  ...
  return (
    <div className="w-full flex flex-col gap-6" id="script-editor-container">
        ...
        <div className="flex flex-wrap gap-2">
          {SCRIPT_PRESETS.map((preset, index) => (
            <button
              ...
              className="px-3 py-1.5 bg-neutral-900 hover:bg-neutral-800 text-neutral-300 rounded-lg text-xs font-medium border border-neutral-800 hover:border-neutral-700 transition active:scale-95 text-left"
            >
              {preset.title}
            </button>
          ))}
      ...
      <div className="flex flex-col gap-2" id="script-textarea-wrapper">
        ...
        {showTagHelp && (
          <div className="p-3.5 bg-neutral-900 border border-neutral-800 rounded-xl text-xs text-neutral-400 leading-relaxed space-y-2 animate-fadeIn" id="syntax-guide-box">
            ...
            <ul className="list-disc pl-4 space-y-1">
              <li>
                <strong className="text-yellow-400">[pause:X]</strong> atau <strong className="text-yellow-400">&lt;pause:X&gt;</strong>: Memberikan jeda X detik pada kata sebelumnya. Contoh: <code className="bg-neutral-950 px-1 py-0.5 rounded text-red-300">Halo [pause:1.5] dunia</code> (jeda 1.5 detik setelah kata Halo).
              </li>
              <li>
        ...
        <div className="flex flex-wrap gap-2 items-center" id="quick-injectors-row">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 text-neutral-300 text-xs rounded-md font-medium transition flex items-center gap-1"
          >
        ...
        <textarea
          ...
          className="w-full h-44 bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-3 text-sm text-neutral-200 placeholder-neutral-600 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 font-sans leading-relaxed resize-y"
        />
      </div>

      {/* 3. Real-time Analysis stats row */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3" id="script-analytics-stats">
        <div className="p-3 bg-neutral-900/60 border border-neutral-800 rounded-xl" id="stat-words">
        ...
        <div className="p-3 bg-neutral-900/60 border border-neutral-800 rounded-xl" id="stat-duration">
        ...
        <div className="p-3 bg-neutral-900/60 border border-neutral-800 rounded-xl" id="stat-pause-tags">
        ...
        <div className="p-3 bg-neutral-900/60 border border-neutral-800 rounded-xl" id="stat-hold-tags">
      ...
      {/* 4. Controls section */}
      <div className="p-4 bg-neutral-900/40 border border-neutral-800/80 rounded-2xl flex flex-col gap-5" id="editor-speed-pacing-controls">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4" id="range-sliders-block">
          ...
          {/* Autopacing trigger */}
          <div className="flex flex-col justify-center gap-1.5 bg-neutral-950 p-3 rounded-xl border border-neutral-800">
        ...
        {mode === PrompterMode.PHRASE && (
          <div className="flex items-center justify-between bg-neutral-950 p-3 rounded-xl border border-neutral-800 animate-slideDown" id="phrase-mode-settings-panel">
            <div className="flex flex-col">
